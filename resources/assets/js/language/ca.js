export default {
  global: {
    tweet: 'He votat en què projectes vull que la Vila Joiosa invertisca'
  },
  option: {
    cost: 'Cost',
  ...
  booth_receipt: {
    ...
    social: 'Convida les teues amistats a participar i fem la Vila Joiosa que volem entre tots i totes ;)',
