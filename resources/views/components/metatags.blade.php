...
<link rel="icon" type="image/png" href="{{ secure_asset('images/favicon.png') }}" sizes="310x310">
...
<meta name="msapplication-TileImage" content="{{ secure_asset('images/favicon.png') }}">
...
<meta property="og:image" content="{{ secure_asset('images/ogimage.jpg') }}"/>
...
<meta property="twitter:image" content="{{ secure_asset('images/ogimage.jpg') }}"/>
